  ...
  return (
    <section className="w-full flex justify-center  px-4 my-10 py-10">
      <div className=" flex flex-col max-w-6xl gap-10 items-center justify-center  w-full">
        ...
        <h3 className="text-2xl font-semibold text-muted-foreground italic">
          The Heart Behind What We Do{" "}
        </h3>
        <div className="flex flex-col max-w-6xl gap-10 w-full items-center ">
          <p className="text-muted-foreground max-w-2xl ">
            <span className="text-primary font-bold">Our mission</span> is
            rooted in{" "}
        ...
        <div className="grid  md:grid-cols-4 sm:grid-cols-2 gap-6">
          <StatCard
            icon={<Clock className="text-primary w-10 h-10" />}
            value="10+"
            label="Years of Service"
          />
          <StatCard
            icon={<HomeIcon className="text-primary w-10 h-10" />}
            value="14"
